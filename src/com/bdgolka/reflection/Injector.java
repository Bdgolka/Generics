...
public class Injector {
    ...
    private Map<Class<?>, Object> objectGrapg = new HashMap<>();

    public Injector with(Object value){
        objectGrapg.put(value.getClass(), value);
        return this;
    }

    public <T>T newInstance (final Class<T> type){

        return (T)objectGrapg.computeIfAbsent(type, this::instantiate);
    }
    ...
    private Object instantiate(Class<?> type) {
        try {
            ...
            Object[] args = Stream.of(constructor.getParameterTypes())
                    .map(param -> (Object) newInstance(param)).toArray();
